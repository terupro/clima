...
class _$WeatherTearOff {
  ...
  _Weather call({WeatherInfo? info, String? name}) {
    return _Weather(
      info: info,
      name: name,
    );
...
/// @nodoc
mixin _$Weather {
  WeatherInfo? get info => throw _privateConstructorUsedError;
...
abstract class $WeatherCopyWith<$Res> {
  ...
  $Res call({WeatherInfo? info, String? name});
...
class _$_Weather with DiagnosticableTreeMixin implements _Weather {
  _$_Weather({this.info, this.name});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Weather(info: $info, name: $name)';
  }
...
abstract class _Weather implements Weather {
  factory _Weather({WeatherInfo? info, String? name}) = _$_Weather;
